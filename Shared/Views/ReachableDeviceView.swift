...
struct ReachableDeviceView: View {
    ...
    var unlockAction: (LKScanResult) -> Void
...
struct ReachableDeviceView_Previews: PreviewProvider
{
    static var previews: some View {
        let device = LKScanResult(kind: .livviKey,
                                  serial: LKSerial(serial: Data(base64Encoded: "LLKFAABAAADABO33")!),
                                  macAddress: "0F:B3:4C:5F")
        ReachableDeviceView(device: device, unlockAction: { _ in })
    }
}
